...
fn main() {
    ...
    let reactangle: Rectangle = Rectangle {
        p1: origin(),
    ...
    println!("Rectangle occupies {} bytes in the stack", mem::size_of_val(&reactangle));
    ...
    println!("Another unboxed point occupies {} bytes in the stack", mem::size_of_val(&another_unboxed_point));
}